    ...
    <ThemeContext.Provider value={currentTheme}>
      ...
      >
        ...
        <form className="note-form">
          ...
          <div><textarea id = 'contentID'></textarea></div>
          <div>
            <select id="labelID">
          ...
          <div><button type="submit" onClick={createNoteHandler}>Create Note</button></div>
        </form>
          ...
          {notes.map((note) => (
            <div 
              ...
              <div className="notes-header">
                ...
                <button onClick={()=>closeNoteHandler(note)}>x</button>
              </div>
